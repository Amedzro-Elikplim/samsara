      ...
      <section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:max-w-xl">
          ...
          <blockquote className=" w-[70%] mx-auto my-auto">
                <p className="text-3xl font-raleway font-gray-500 italic">“Cleaning is not just about tidying up our surroundings; it's a reflection of the care we extend to ourselves and others. A clean space fosters clarity of mind, a sense of calm, and a brighter outlook on life.”</p>
